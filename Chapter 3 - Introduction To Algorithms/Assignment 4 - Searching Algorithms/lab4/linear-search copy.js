...
assert.strictEqual(
  linearSearch(inputArray, 3),
  -1,
  "Test case 1 output is wrong."
);
assert.strictEqual(
  linearSearch(inputArray, 1),
  0,
  "Test case 2 output is wrong."
);
assert.strictEqual(
  linearSearch(inputArray, 4),
  2,
  "Test case 3 output is wrong."
);
assert.strictEqual(
  linearSearch(inputArray, 7),
  4,
  "Test case 4 output is wrong."
);
assert.strictEqual(
  linearSearch(inputArray, 10),
  6,
  "Test case 5 output is wrong."
);
assert.strictEqual(
  linearSearch(inputArray, 13),
  8,
  "Test case 6 output is wrong."
);
